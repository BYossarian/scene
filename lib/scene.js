...
function _shade(scene, ray, intersection, recursionDepth) {
    ...
    const rayColor = {
        r: diffuseColor.r * totalIntensity,
        g: diffuseColor.g * totalIntensity,
        b: diffuseColor.b * totalIntensity
    };
...
function render(surfaces, lights, renderTarget, options) {
    ...
    const scene = {
            ...
            background: {
                r: _clamp(background.r / 255, 0, 1),
                g: _clamp(background.g / 255, 0, 1),
                b: _clamp(background.b / 255, 0, 1)
            }
        };
